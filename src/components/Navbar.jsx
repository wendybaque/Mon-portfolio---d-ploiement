...
const Navbar = () => {
  return (
    <div>
      <nav role="navigation" className="bg-slate-50 border-slate-100 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          <a href="/" className="flex items-center" alt="redirection vers la page d'accueil">
            <img
              src={Wendy}
